...
const features = [
  { 
    title: "pH 7.2", 
    description: "Optimal acidity for safe reuse."
  },
  { 
    title: "12 NTU", 
    description: "Crystal clear turbidity levels."
  },
  { 
    title: "320 mV ORP", 
    description: "Strong oxidation-reduction potential."
  },
  { 
    title: "28.5°C", 
...
export function DevelopersSection() {
  ...
  return (
    <section id="dashboard" ref={sectionRef} className="relative py-24 lg:py-32 overflow-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-start">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground mb-12 leading-relaxed">
              Monitor every parameter. Every second. From anywhere.
            </p>
