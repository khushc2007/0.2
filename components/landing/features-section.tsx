...
const features = [
  {
    ...
    description: "Greywater enters a swirl chamber where a precision propeller stabilizes turbulent flow, ensuring uniform distribution for downstream processing.",
    visual: "deploy",
  },
  {
    number: "02",
    title: "Oil Separation",
    description: "Floating oils and soap residues are removed using a precision surface plate, eliminating up to 95% of surface contaminants before analysis.",
    visual: "ai",
  },
  {
    number: "03",
    title: "Sensor Array",
    description: "Five-parameter sensor array measures pH, turbidity, TDS, ORP, and ammonia levels simultaneously in real time.",
    visual: "collab",
  },
  {
    number: "04",
    title: "Membrane Filtration",
    description: "Advanced dual-membrane barriers capture particulates down to 0.1 microns, delivering clean pre-treated water for quality scoring.",
    visual: "security",
  },
];
...
function AIVisual() {
  // Pre-calculate node positions as strings to avoid precision mismatches
  const nodes = [
    { x: "150", y: "80" },
    { x: "125", y: "123.2" },
    { x: "75", y: "123.2" },
