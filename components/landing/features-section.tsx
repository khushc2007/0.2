...
const features = [
  {
    number: "01",
    title: "Propeller Flow Control",
    description: "Incoming greywater enters a mixing chamber where a precision propeller — driven by a motor mounted outside the cylinder — slows and distributes turbulent flow before it reaches the electrocoagulation plates below.",
    visual: "deploy",
  },
  {
    number: "02",
    title: "Electrocoagulation Chamber",
    description: "Six to eight aluminium disc electrodes spanning the full cylinder cross-section release Al³⁺ ions under 12V DC current. These ions form aluminium hydroxide floc that binds suspended solids, surfactants, and pathogens into heavy particles that sink to the bottom. Water is held for 15 minutes.",
    visual: "ai",
  },
  {
    number: "03",
    title: "Timed Gate",
    description: "A servo-controlled solid disc sits against a fixed perforated disc. The ESP32 holds this gate closed for a minimum of 15 minutes, guaranteeing full EC contact time. When the timer fires, the servo rotates the disc open and water flows through.",
    visual: "security",
  },
  {
    number: "04",
    title: "Sensor Pod",
    description: "A unified sensor pod positioned between the timed gate and the lamella section measures pH, turbidity (×2), and TDS simultaneously. All three readings are transmitted to the AI backend every 3.5 seconds for real-time quality scoring.",
    visual: "collab",
  },
  {
    number: "05",
    title: "Lamella Settling",
    description: "Two opposing acrylic strips arranged in a V-shape covering 45% of the cylinder each — with a 10% gap at the centre — allow coagulated floc to slide down by gravity and fall into the collection zone below. Clean water rises above.",
    visual: "deploy",
  },
  {
    number: "06",
    title: "AI Routing Decision",
    description: "The six-layer intelligence stack computes a Water Quality Index (0–100), cross-sensor confidence score, flatline detection, auto-recalibration, cycle fingerprinting, and stage-aware classification. The system routes water to Tank A (reuse) or Tank B (discard) with zero human input.",
    visual: "ai",
  },
];
...
export function FeaturesSection() {
  ...
  return (
    <section id="solution" ref={sectionRef} className="relative py-24 lg:py-32">
